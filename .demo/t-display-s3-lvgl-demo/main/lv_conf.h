...
#define LV_USE_STDLIB_MALLOC LV_STDLIB_BUILTIN
#define LV_MEM_CUSTOM_INCLUDE "lv_custom_mem.h" // Header-ul pentru funcțiile personalizate
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_POOL_ALLOC(size) heap_caps_malloc(size, MALLOC_CAP_SPIRAM)      // for SpiRam
    ////#define LV_MEM_POOL_ALLOC(size) heap_caps_malloc(size, MALLOC_CAP_INTERNAL)  // for Internal RAM
 ...
 *  10 ms --> 93 - 99 FPS
 *  13 ms --> 66 - 69 FPS
 *  LV_DEF_REFR_PERIOD = 1 ms se ajunge la 200 FPS
*/
...
#define LV_DRAW_BUF_STRIDE_ALIGN                1 // 1
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_DRAW_UNIT_CNT    /*1*/ 2
...
#define LV_USE_FS_STDIO 1 // 0
    ...
    #define LV_FS_STDIO_CACHE_SIZE 64    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
#define LV_USE_FS_FATFS 1
    ...
    #define LV_FS_FATFS_CACHE_SIZE 64    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
#define LV_USE_SYSMON   1
    ...
    #define LV_SYSMON_GET_IDLE lv_timer_get_idle // from old lvgl8
    ////#define LV_SYSMON_GET_IDLE lv_os_get_idle_percent // nu e asa bun..
...
//#define LV_USE_RENESAS_GETDC    0 // old
/** Driver for Renesas GLCD */
...
#if LV_USE_OPENGLES
    #define LV_USE_OPNEGLFS_DEBUG        1    /* Enable or disable debug for opengles */
#endif
...
//#pragma message "lv_conf.h a fost parsat"
